...
export const MainPage: FC = () => {
	return (
		<main
			...
			style={{ userSelect: 'none' }}
		>
			<div className="relative z-10 flex flex-col items-center pt-2 md:pt-4 xl:pt-28">
				...
				<div className="hidden md:flex justify-between items-start max-w-screen-2xl mx-auto px-4">
					...
					<motion.img
						...
						transition={{ duration: 3, delay: 6.5, ease: 'easeInOut' }}
						src="./public/f-name-logo.png"
						className="w-64 md:w-72 lg:w-80 xl:w-116"
					/>
					{/* Char */}
					<motion.div
						initial={{ opacity: 0, y: '100vh' }}
					...
					>
						<img
							src="./public/char.png"
							className="w-48 md:w-56 lg:w-64 xl:w-[370px]"
						/>
					</motion.div>
					{/* Last Name */}
					<motion.img
				...
				<motion.div
					...
					className="relative z-10  flex flex-col items-center w-full max-w-[320px] md:max-w-[600px] lg:max-w-[900px] xl:max-w-[1200px] px-4 md:px-0 mt-4 md:mt-[-95px]"
				>
					{/* Top Ripped - скрыто на мобильных */}
					<img
						src="./public/ripped.png"
						className="hidden md:block w-[90%] lg:w-[95%] xl:w-[1100px] rotate-180"
					/>

					{/* Card Container */}
					<div className="flex items-center w-auto md:gap-1 lg:gap-2 xl:gap-3 md:-mt-20 lg:-mt-24 xl:-mt-26">
						{/* Left Side - скрыто на мобильных */}
						<img
							src="./public/ripped-side.png"
							className="hidden md:block w-[30px] lg:w-[40px] xl:w-[50px] h-auto rotate-180 mt-12 lg:mt-16 xl:mt-18 -ml-6 lg:-ml-8 xl:-ml-10"
						/>

						{/* Main Card */}
						<div className="relative w-full md:w-[90%] lg:w-[95%] xl:w-[1040px] pb-6 md:pb-8 xl:pb-10 bg-zinc-900 rounded-xl md:rounded-tr-2xl md:rounded-tl-2xl lg:rounded-tr-3xl lg:rounded-tl-3xl xl:rounded-tr-4xl xl:rounded-tl-4xl pt-4 md:pt-5 xl:pt-4 px-6 md:px-8 lg:px-10 xl:px-12 flex justify-center">
							<Card />
						</div>
						...
						<img
							src="./public/ripped-side.png"
							className="hidden md:block h-[300px] lg:h-[450px] xl:h-[570px] mt-12 lg:mt-16 xl:mt-20 -mr-3 lg:-mr-4 xl:-mr-8"
						/>
						...
						<motion.img
							...
							transition={{ duration: 3, delay: 8, ease: 'easeIn' }}
							src="./public/skull1.png"
							className="absolute z-30 w-16 md:w-24 lg:w-32 xl:w-[280px] -left-2 md:-left-6 lg:-left-8 xl:-left-10 -rotate-12 md:-rotate-20 xl:-rotate-25 bottom-8 md:bottom-12 xl:bottom-3"
						/>
						<motion.img
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
							transition={{ duration: 3, delay: 8, ease: 'easeIn' }}
							src="./public/skull1.png"
							className="absolute z-30 w-16 md:w-24 lg:w-32 xl:w-[300px] -right-2 md:-right-6 lg:-right-8 xl:-right-10 bottom-8 md:bottom-12 xl:bottom-2 scale-x-[-1] rotate-12 md:rotate-20 xl:rotate-25"
						/>
					</div>
				</motion.div>
			</div>
