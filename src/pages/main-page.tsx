				...
				<div className="flex flex-col items-center pt-3 md:pt-18 xl:pt-14 2xl:pt-6 lg:pt-18 sm:pt-12">
					...
					>
						...
						<motion.img
							...
							src="/skull1.png"
							className="absolute z-30 sm:w-72 md:w-56 lg:w-60 xl:w-[280px] 3xl:w-[400px] sm:-left-36 sm:-bottom-32 md:-left-24 lg:-left-20 xl:-left-10 md:-rotate-20 xl:-rotate-25 md:bottom-8 lg:bottom-10 xl:bottom-18 2xl:bottom-32 3xl:-bottom-20 3xl:-left-36"
						/>
						<motion.img
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
							transition={{ duration: 3, delay: 8, ease: 'easeIn' }}
							src="/skull1.png"
							className="absolute z-30 sm:w-72 md:w-52 lg:w-58 xl:w-[300px] 3xl:w-[420px] sm:-right-36 sm:-bottom-32 md:-right-16 lg:-right-12 xl:-right-10 md:bottom-7 lg:bottom-8 xl:bottom-17 2xl:bottom-32 3xl:-bottom-20 3xl:-right-30 scale-x-[-1] md:rotate-20 xl:rotate-25"
						/>
					</motion.div>
